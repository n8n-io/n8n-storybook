import{N as s}from"./Card-d86c8b07.js";import{N as h}from"./Button-7453724f.js";import{N as x}from"./Icon-56e50434.js";import{N as b}from"./Text-c7071bfc.js";import"./vue.esm-bundler-3aad6c04.js";import"./_plugin-vue_export-helper-c27b6911.js";import"./Spinner-ae3926a4.js";const z={title:"Atoms/Card",component:s},r=(e,{argTypes:n})=>({setup:()=>({args:e}),props:Object.keys(n),components:{N8nCard:s},template:'<n8n-card v-bind="args">This is a card.</n8n-card>'}),t=(e,{argTypes:n})=>({setup:()=>({args:e}),props:Object.keys(n),components:{N8nCard:s,N8nIcon:x,N8nText:b},template:`<div style="width: 140px; text-align: center;">
        <n8n-card v-bind="args">
            <n8n-icon icon="plus" size="xlarge" />
            <n8n-text size="large" class="mt-2xs">Add</n8n-text>
        </n8n-card>
    </div>`});t.args={hoverable:!0};const a=(e,{argTypes:n})=>({setup:()=>({args:e}),props:Object.keys(n),components:{N8nCard:s,N8nButton:h,N8nIcon:x,N8nText:b},template:`<n8n-card v-bind="args">
        <template #prepend>
...
//# sourceMappingURL=Card.stories-4f08366f.js.map
